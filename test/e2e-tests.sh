...
test_dashboard() {
  ...
  docker run --rm --network=host $CYPRESS_ENV -v /root/.kube:/home/.kube --env KUBECONFIG=/home/.kube/config -v $VIDEO_PATH:/home/node/cypress/videos dashboard-e2e $CYPRESS_SPEC || fail_test "Browser E2E tests failed"
